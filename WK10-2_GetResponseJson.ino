...
const char* ssid = "慰的";  // insert your SSID
const char* password = "fall159753";  // insert your password
const char* host = "api.openweathermap.org";
const char* resource = "/data/2.5/weather?id=1668341&appid=cf04c399758c44fc421880d2abcc5352";
const char* host2 = "maker.ifttt.com"; //IFTTT server網址
const char* event = "test";  //IFTTT事件名稱
const char* apiKey = "dxx6gVGUQF4_s4P-TaUPI9";  //IFTTT Applet key 
...
void loop(){
    ...
    Serial.println("%");
    Serial.println("--------------------"); 
    SendLineNotyfy(String(weather),String(temp),String(humidity)) ;
...
//  SendLineNotyfy(String (value1), String (value2), String (value3));  //Client傳送資料
